...
class DummyStrategy:
    ...
    def on_market_data(self, ctx, market_data):
        ...
        return [{'code':'600000.SH','signal_type':'BUY','volume':10,'price':market_data['600000.SH']['close'].iloc[-1]}]
...
def test_paper_pnl_estimation(tmp_path):
    ...
    reports = run_paper(app=app, rounds=1, stocks=['600000.SH'], report_path=str(tmp_path / 'r.json'))
